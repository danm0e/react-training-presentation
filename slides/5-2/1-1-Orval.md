...
- Generates API clients from OpenAPI/Swagger definitions, with appropriate type-signatures (TypeScript).<!-- .element: class="fragment" -->
---
...
- Generate the API client from the API definition itself.<!-- .element: class="fragment" -->
- Integrate the API client in our unit tests. Orval provides first class support for mocking through the Mock Service Worker library, and it can automatically generate the MSW handlers for testing server.<!-- .element: class="fragment" -->
