...
In the example below, we can see that the change that the function makes to the object impacts the original object too. This is because it is passed by reference.
```js
